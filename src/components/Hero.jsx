...
<section className="w-full h-[calc(100vh-60px)] bg-black relative">
  ...
  className="flex flex-col items-center opacity-0 translate-y-20">
    <a href="#highlights" className="px-5 py-2 rounded-3xl bg-blue-500 my-5 hover:bg-transparent border border-transparent hover:border hover:text-blue-100 hover:border-blue-700">Buy</a>
